        ...
        <div className='col-span-12 lg:col-span-5 md:p-4 p-0  mb-0'>
          <div className="flex flex-col items-center justify-center min-h-screen bg-white px-12">
            <div className="w-full max-w-md">
              <h1 className="text-2xl font-bold text-center mb-8 text-[#3a1c64] mt-0 md:-mt-28">Welcome Back</h1>
              ...
              <div className="space-y-4">
                ...
                <div className='flex gap-2 items-center'>
                  ...
                  <label className='ml-auto text-sm font-thin'> Forgot Password</label>
                </div>
                {/* Sign Up Button */}
